...
@.str = private unnamed_addr constant [16 x i8] c"Fibonacci(10): \00", align 1
@.str.1 = private unnamed_addr constant [15 x i8] c"Factorial(5): \00", align 1
...
define dso_local noundef i32 @_Z9fibonaccii(i32 noundef %n) #4 {
entry:
...
; Function Attrs: mustprogress noinline optnone uwtable
define dso_local noundef i32 @_Z9factoriali(i32 noundef %n) #4 {
entry:
  %retval = alloca i32, align 4
  %n.addr = alloca i32, align 4
  store i32 %n, ptr %n.addr, align 4
...
entry:
  ...
  %call1 = call noundef i32 @_Z9fibonaccii(i32 noundef 10)
  ...
  %call5 = call noundef i32 @_Z9factoriali(i32 noundef 5)
  %call6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call4, i32 noundef %call5)
...
!5 = !{!"clang version 18.1.8 (https://github.com/llvm/llvm-project 3b5b5c1ec4a3095ab096dd780e84d7ab81f3d7ff)"}
